...
$\M = \Wq^\top \Wk$. Because \M is generally non-symmetric --- hence non-normal --- it carries a complex
eigenspectrum and non-orthogonal eigenvectors, the setting where non-Hermitian and random-matrix tools apply. But
what kind of fact about a head does that spectrum encode? We give a three-level answer for previous-token/induction circuits.
...
earlier predictive signature --- and the population-median suppression that produces the final profile follows
